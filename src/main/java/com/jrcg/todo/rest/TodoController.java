...
import com.jrcg.todo.repository.TodoRepository;
...
public class TodoController {
	...
	@GetMapping
	public List<Todo> listarTodasTarefas() {
	...
	public Todo marcaComoRealizado(@PathVariable Long id) {
		return todoRepository.findById(id).map(todo -> {
			todo.setFinalizado(true);
			todo.setConclusao(LocalDateTime.now());
